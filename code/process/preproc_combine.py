...
def combinePatData():
    ...
    data['fmriprep_MNI'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_space-MNI152NLin2009cAsym_desc-preproc_T1w.nii.gz'
    data['fmriprep_MNI_GM'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_space-MNI152NLin2009cAsym_label-GM_probseg.nii.gz'
    data['fmriprep_MNI_WM'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_space-MNI152NLin2009cAsym_label-WM_probseg.nii.gz'
    data['fmriprep_MNI_CSF'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_space-MNI152NLin2009cAsym_label-CSF_probseg.nii.gz'
    data['fmriprep_MNI_brainmask'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_space-MNI152NLin2009cAsym_desc-brain_mask.nii.gz'
    data['fmriprep_native'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_desc-preproc_T1w.nii.gz'
    data['fmriprep_native_GM'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_label-GM_probseg.nii.gz'
    data['fmriprep_native_WM'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_label-WM_probseg.nii.gz'
    data['fmriprep_native_CSF'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_label-CSF_probseg.nii.gz'
    data['fmriprep_native_brainmask'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_desc-brain_mask.nii.gz'
    data['fmriprep_native2MNI'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_from-T1w_to-MNI152NLin2009cAsym_mode-image_xfm.h5'
    data['fmriprep_MNI2native'] = data['BIDS_ROOT'] + os.sep + 'anat' + os.sep + 'sub-' + data['KEY'] + '_from-MNI152NLin2009cAsym_to-T1w_mode-image_xfm.h5'
